...
. "$MMDAPP/source/myx/myx.distro-prepare/sh-scripts/SyncSourceProjectToCached.fn.sh"

type ListAllRepositoryProjects >/dev/null 2>&1 || \
. "$MMDAPP/source/myx/myx.distro-prepare/sh-scripts/ListAllRepositoryProjects.fn.sh"
